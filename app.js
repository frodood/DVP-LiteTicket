...
server.put('/DVP/API/:version/Tag/:id/AttachTo/:tagid', authorization({resource:"tag", action:"write"}), tagService.AttachTagsToTag);
...
server.put('/DVP/API/:version/Tag/:id/DetachFromCategory/:cid', authorization({resource:"tag", action:"write"}), tagService.DetachTagsFromCategory);
