...
function AddAction(req, res){
    ...
    Trigger.findOneAndUpdate({_id: req.params.id,company: company, tenant: tenant}, { $addToSet :{
        actions : {
...
function RemoveAction(req, res){
    ...
    Trigger.findOneAndUpdate({_id: req.params.id,company: company, tenant: tenant}, { $pull :{
        actions : {
